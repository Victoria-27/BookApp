...
function pagination(model) {
    return function paginate(req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var params, params__, page, limit, result_1, startIndex, endIndex, result, _a, _b, err_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        params = req.query.page;
                        params__ = req.query.limit;
                        page = parseInt(params);
                        limit = parseInt(params__);
                    ...
                    case 4:
                        _c.trys.push([4, 6, , 7]);
                        _b = result;
                        return [4 /*yield*/, model.find().limit(limit).skip(startIndex)];
                    case 5:
                        _b.users = _c.sent();
